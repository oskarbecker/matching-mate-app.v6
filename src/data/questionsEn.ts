...
export const questionsLesbischFrauEn: Question[] = [
  ...
  { id: 'm', text: 'Independence – own goals, educated, self-reliant', points: 3 },
  { id: 'n', text: 'Not confrontational – gives the partner her peace', points: 6 },
  { id: 'o', text: 'Desire for sex – especially at the beginning of the relationship', points: 7 },
  { id: 'p', text: 'Conversational skills – capable of small talk', points: 4 },
  { id: 'q', text: 'Not chatty – can also listen', points: 5 },
  { id: 'r', text: 'Shared interests with partner – common hobbies etc.', points: 4 },
];
