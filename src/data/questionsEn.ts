...
export const questionsLesbischFrauEn: Question[] = [
  ...
  { id: 'i', text: 'No wrinkles', points: 2.5 },
  { id: 'j', text: 'Little fat (but not anorexic)', points: 2.5 },
  { id: 'k', text: 'Styling (attractive look, but not vulgar, cheap)', points: 2.5 },
  { id: 'l', text: 'Independence – own goals, educated, self-reliant', points: 2 },
  { id: 'm', text: 'Not confrontational – gives the partner her peace', points: 5 },
  { id: 'n', text: 'Desire for sex – especially at the beginning of the relationship', points: 7 },
  { id: 'o', text: 'Conversational skills – capable of small talk', points: 3 },
  { id: 'p', text: 'Not chatty – can also listen', points: 4 },
  { id: 'q', text: 'Shared interests with partner – common hobbies etc.', points: 1 },
];
