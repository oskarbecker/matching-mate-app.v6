...
import { questionsGayMann } from './data/questions';
import { questionsGayMannEn } from './data/questionsEn';
...
export default function BewertungGay1Page({ answers, setAnswers }: Props) {
  ...
  const questions = language === 'de' ? questionsGayMann : questionsGayMannEn;
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center' }}>
        <button
          onClick={() => navigate('/bewertung-gay-2')}
          style={{
            padding: '1rem 2rem',
            fontSize: '1.2rem',
            background: '#4169e1',
        ...
        >
          ➡️ {t('evaluation.button.evaluate.man2')}
        </button>
      </div>
    </div>
  );
