...
import { questionsLesbischFrau } from './data/questions';
import { questionsLesbischFrauEn } from './data/questionsEn';
...
export default function BewertungLesbian1Page({ answers, setAnswers }: Props) {
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center' }}>
        <button
          onClick={() => navigate('/bewertung-lesbian-2')}
          style={{
            padding: '1rem 2rem',
            fontSize: '1.2rem',
            background: '#9932cc',
        ...
        >
          ➡️ {t('evaluation.button.evaluate.woman2')}
        </button>
      </div>
    </div>
  );
